...
APP_CFLAGS += -DAT_IMAGE=$(IMAGE) -DPERF -DMODEL_ID=$(MODEL_ID)
APP_CFLAGS += -DAT_CNN=$(AT_CNN) -DAT_CONSTRUCT=$(AT_CONSTRUCT) -DAT_DESTRUCT=$(AT_DESTRUCT) -DAT_FLASH_ADDR=$(AT_FLASH_ADDR)
